...
"""Verify that starting gspcoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gspcoind with -h for help text")
        ...
        self.log.info("Start gspcoind with -version for version information")
