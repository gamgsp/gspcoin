...
from test_framework.test_framework import GspcoinTestFramework
...
class LLMQChainLocksTest(GspcoinTestFramework):
    def set_test_params(self):
        self.set_gspcoin_test_params(6, 5, fast_dip3_enforcement=True)
