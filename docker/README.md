...
official/supported Docker Images found at https://hub.docker.com/r/gspcoin/gspcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/gspcoin/gspcoind-develop/ when changing the above text**