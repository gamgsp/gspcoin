...
//XN3AuWKZHusQnR9KPrB4rTMztKhXdqWWmZDszj71FFuzwwVNdZ1t
...
{
    const char* pszTimestamp = "GSP project of Global Ads Media.";
    const CScript genesisOutputScript = CScript() << ParseHex("04d615ef8eb23c81171ae0e29f9c2c869d82cc669cbeebe8c8b238c8143abe31e13e62c16f06f72fea7496c250180bda35b13d1e85282c7559f077f0d1e5f6331b") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gspcoin: 1 day
        consensus.nPowTargetSpacing = 4 * 60; // Gspcoin: 2,5 minutes
        ...
        consensus.smartnodePaymentFixedBlock = 2600;
         ...
         */
        pchMessageStart[0] = 0xdd;//g
        pchMessageStart[1] = 0x13;//s
        pchMessageStart[2] = 0x41;//p
        pchMessageStart[3] = 0x71;//c
        nDefaultPort = 27653;
        nPruneAfterHeight = 100000;
        //FindMainNetGenesisBlock(1666459880, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1666459880, 641, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd46e50cd2ff0d0e06d3edd122cc30b32dd0b0526e96682006d5da71359b8d872"));
        assert(genesis.hashMerkleRoot == uint256S("0x088a1d08829fce71ceecb6b357c37b8a9e242b75fd7d8e0c2e45daf8535e5ff3"));

        vSeeds.emplace_back("explorer.globalsocialpost.com");
        vSeeds.emplace_back("api.globalsocialpost.com");
        vSeeds.emplace_back("electrumx.globalsocialpost.com");
        vSeeds.emplace_back("node1.globalsocialpost.com");
        vSeeds.emplace_back("node2.globalsocialpost.com");
        vSeeds.emplace_back("node3.globalsocialpost.com");
        vSeeds.emplace_back("node4.globalsocialpost.com");
        vSeeds.emplace_back("node5.globalsocialpost.com");
        vSeeds.emplace_back("node6.globalsocialpost.com");


        // Gspcoin addresses start with 'B'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,38);
        // Gspcoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,102);
        // Gspcoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,205);
        // Gspcoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x03, 0x37, 0xB3, 0xBC};
        // Gspcoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x03, 0x37, 0xB4, 0x41};
        // Gspcoin BIP44 coin type is '5'
...
//        }
        ...
        vSporkAddresses = {"GKEyDWA7PxTuCQVLindtXABAZdnUyPdRuz", "GUv6SEWc4SGHUkC2cmqMptNFypqcJFHGXD"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
          {  {0, uint256S("0xd46e50cd2ff0d0e06d3edd122cc30b32dd0b0526e96682006d5da71359b8d872")} }
	};

        chainTxData = ChainTxData{
          1666459880,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gspcoin: 1 day
        consensus.nPowTargetSpacing = 60; // Gspcoin: 1 minutes
        ...
        pchMessageStart[0] = 0xe6; //t
        pchMessageStart[1] = 0x12; //g
        pchMessageStart[2] = 0x6b; //s
        pchMessageStart[3] = 0x10; //p
        nDefaultPort = 10228;
        nPruneAfterHeight = 1000;
        //FindMainNetGenesisBlock(1666459881,  0x20001fff, "test");
        genesis = CreateGenesisBlock(1666459881, 219, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5b6f9a83825aee937ffe352eb8e162b04efa48ff2fc3362e5fc22284ce7e0502"));
        assert(genesis.hashMerkleRoot == uint256S("0x088a1d08829fce71ceecb6b357c37b8a9e242b75fd7d8e0c2e45daf8535e5ff3"));
        ...
        vSeeds.emplace_back("testnet.globalsocialpost.com");
        vSeeds.emplace_back("testnet1.globalsocialpost.com");
        vSeeds.emplace_back("testnet2.globalsocialpost.com");
        vSeeds.emplace_back("testnet3.globalsocialpost.com");
        vSeeds.emplace_back("testnet4.globalsocialpost.com");

        // Testnet Gspcoin addresses start with '
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Testnet Gspcoin script addresses start with '8' or '9'
        ...
        // Testnet Gspcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x03, 0x3D, 0x70, 0x08};
        // Testnet Gspcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x03, 0x3D, 0x70, 0x8D};

        // Testnet Gspcoin BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "TWU79KDKZe5WyrMT9yM7XBtGy5t9a7CruJ");
        ...
        vSporkAddresses = {"THX7v7e3J7YhS6rSW5SoKbXE9byLDMfUy4"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;
        ...
        chainTxData = ChainTxData{
            1666459881, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gspcoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Gspcoin: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("gspcoinevo.org",  "devnet-seed.gspcoinevo.org"));

        // Testnet Gspcoin addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Gspcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Gspcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Gspcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Gspcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Gspcoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
