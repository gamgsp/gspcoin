...
/** Utility functions used by the Gspcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "gspcoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load gspcoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a gspcoin specific theme is activated (light/dark).*/
