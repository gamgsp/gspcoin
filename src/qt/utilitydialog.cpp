    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  gspcoin-qt [command-line options]                     \n";
...
All the Gspcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 GSPC, 0.01 GSPC, 0.1 GSPC, 1 GSPC and 10 GSPC -- sort of like the paper money you use every day.</li> \
