...
//! Interface for the src/evo part of a gspcoin node (gspcoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a gspcoin node (gspcoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a gspcoin node (gspcoind process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a gspcoin node (gspcoind process).
class Node
{
public:
    virtual ~Node() {}
