...
#ifndef GSPCOIN_ARITH_UINT256_H
#define GSPCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Gspcoin only uses this "compact" format for encoding difficulty
