...
public:
    ...
    // Gspcoin Specific WalletInitInterface InitCoinJoinSettings
 ...
 * between gspcoind, and gspcoin-qt and non-server tools.
*/
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-sporkaddr=<gspcoinaddress>", "Override spork address. Only useful for regtest and devnet. Using this on mainnet or testnet will ban you.", false, OptionsCategory::DEBUG_TEST);
    ...
    gArgs.AddArg("-platform-user=<user>", "Set the username for the \"platform user\", a restricted user intended to be used by Gspcoin Platform, to the specified username.", false, OptionsCategory::SMARTNODE);
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Raptor3um/gspcoin>";
    const std::string URL_WEBSITE = "<https://gspcoin.com>";
...
/** Sanity checks
 *  Ensure that Gspcoin Core is running in a usable environment with all
...
bool AppInitMain()
{
    ...
    // ********************************************************* Step 10c: schedule Gspcoin-specific tasks
