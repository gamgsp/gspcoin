...
rm -f src/config/gspcoin-config.h
...
rm -rf test_bitcoin.coverage/ gspcoin-gtest.coverage/ total.coverage/
...
clean_exe src/gspcoin-cli
clean_exe src/gspcoind
clean_exe src/gspcoin-gtest
clean_exe src/gspcoin-tx
clean_exe src/test/test_gspcoin
clean_exe src/test/test_gspcoin_fuzzy
...
clean_dep . src/config/gspcoin-config.h.in
