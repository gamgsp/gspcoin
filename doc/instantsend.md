...
This mechanism has been integrated into Bitcore-Node-Gspcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gspcoin/insight-api-gspcoin#web-socket-api](https://github.com/gspcoin/insight-api-gspcoin#web-socket-api)
* API: [https://github.com/gspcoin/insight-api-gspcoin#instantsend-transactions](https://github.com/gspcoin/insight-api-gspcoin#instantsend-transactions)
