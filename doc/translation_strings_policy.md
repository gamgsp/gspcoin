...
This document provides guidelines for internationalization of the Gspcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gspcoin_en.ts` remains unchanged.
