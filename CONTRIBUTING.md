Contributing to Gspcoin Core
============================

The Gspcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Raptor3um/gspcoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Gspcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Gspcoin
Network Protocol consensus changes.

Whether a pull request is merged into Gspcoin Core rests with the project merge
...
Patches that change Gspcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gspcoin consensus, it must have been
...
The review process is normally fairly responsive on the Gspcoin Core repository, however
...
The project leader is the release manager for each Gspcoin Core release.
